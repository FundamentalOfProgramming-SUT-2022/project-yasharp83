...
char * BOARD_FILE = "root/.boardfile.txt"  ; 
char  CUR_FILE[MX_CMD];
char * STR_VIM_MODE[4] = {"no_mode" , "visual" , "normal", "insert" } ; 
int VIM_MODE = 0  , MX_X , MX_Y , cur_x , cur_y; // 0 no_mode 1 visual 2 normal 3 insert
int l_up = 1 ;
